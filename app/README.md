...
- **Legenda do eixo de ação**: sempre visível acima da tabela (recolhível), com os cinco eixos, a condição de cada um e o que significa, na ordem de precedência (Cobrança > Reter já > Reter / vigiar > Saída organizada > Sem urgência).
